...
const Members = ({ team, userId, setTeam, editable = false, ...rest }) => {
  ...
  const selectableStudents = useMemo(() => 
    students.filter(student => (!student.team.id || student.team.id === team.id) && !team.members.includes(student.id))
  ...
  return ( 
    <>
      ...
      <div className="field">   
        <label className="label">{editable ? 'Miembros Seleccionados' : 'Miembros'}</label>  
