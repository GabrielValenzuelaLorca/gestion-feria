    ...
    <section className={`modal ${isActive ? "is-active" : ""}`}>
      ...
      <article className="modal-card">
        <header className="modal-card-head">
          <p className="has-text-weight-bold is-size-4">Crear Equipo</p>
        </header>
        ...
        <footer className="modal-card-foot">
          <button
            className={`button is-success ${loadingTeam && "is-loading"}`}
          ...
          <button
            className={`button is-danger ${loadingTeam && "is-loading"}`}
